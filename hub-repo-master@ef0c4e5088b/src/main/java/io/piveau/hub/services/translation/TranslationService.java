...
public interface TranslationService {
    ...
    @Fluent
    TranslationService initializeTranslationProcess(DatasetHelper helper, DatasetHelper oldHelper, Boolean force, Handler<AsyncResult<DatasetHelper>> asyncHandler);
