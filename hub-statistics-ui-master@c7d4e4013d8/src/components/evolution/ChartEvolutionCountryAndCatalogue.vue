  ...
  <div class="container">
    <div class="line-chart">
      <line-chart
        ...
        :date="date_dummy"/>
      <div id="line-chart-catalogue-js-legend"></div>
      </div>
  </div>
</template>
...
import LineChart from './LineChartCountryAndCatalogue.vue'

Vue.use(Trend)

export default {
  /* eslint-disable */
  name: 'Evolution-Catalogue',
  ...
  methods: {
    ...
    requestData () {
      axios.get(this.$env.ROOT_API + '/data/ds-per-catalogue?list=true', { // http://odp-lic.ppe-aws.europeandataportal.eu:9090/data/ds-per-catalogue'
      })
        .then(response => {
